...
export default function Orientation() {
	return (
		<section id="orientation" className="">
			...
			<div className="max-w-6xl mx-auto py-2 px-4">
				<div id="about-orientation">
					...
					<div className="space-y-4 mt-1">
						<p>
							Since the creation of the Undergraduate Student
							Society of Toronto Metropolitan University in 2012,
							the Faculty of Science (FoS) has hosted Science
							Orientation/SciFrosh for incoming students. Science
							Orientation was made to celebrate, welcome, and
							develop a community for all students entering the
							Faculty of Science. It was until 2016 where the
							responsibility of Orientation was placed onto the
							Orientation Committee to continue the efforts of the
							USSTM. Since then, Science Orientation has evolved
							to not only provide a welcoming space for students,
							but also an opportunity to create friendships and
							gain knowledge for their entire university career.
							For some more cool stuff and updates follow our
							Instagram:{" "}
							<a
								href="https://www.instagram.com/scifroshtmu/"
								target="_blank"
							>
								@scifroshtmu
							</a>
						...
						<p>
							This webpage will provide you with all the
							information that you will need to attend and
							navigate Science Orientation 2025.
						</p>
					</div>
					<div
						id="register-orientation"
				...
				<div id="theme-orientation">
					...
					<div className="space-y-4 mt-2">
						<p>
							...
							<br />
							We are so thrilled to have you join us for a week
					...
					<div className="space-y-4 mt-1">
						<p>
							Take a look at some of our memories from past
							Orientation events!
						</p>
						<Carousel imgList={carouselImages} />
					</div>
				</div>
