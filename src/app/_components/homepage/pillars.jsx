    ...
    <>
        <section id="pillars" className="my-12">
            <div className="pillars-container flex justify-evenly items-center min-h-screen max-w-screen relative">
                <div className="banner bg-highlight-dark min-w-full h-3/4 max-w-screen absolute self-center"></div>
                <div className="pillar-grid main h-full grid grid-cols-1 lg:grid-cols-2 absolute">
